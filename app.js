  ...
  rain: {
    ...
    phrases: {
      hype: [
        ...
        "빗소리까지 응원 박자로 들리는 날.",
        "기다리는 동안에도 응원 에너지는 천천히 차오른다.",
        "젖은 공기까지 오늘의 박자처럼 느껴지는 날.",
      ],
      deadpan: [
        "오늘 일정은 취소돼도 과몰입은 정상 영업.",
        "하늘도 쉬라는데 내 머릿속은 이미 라인업.",
        "비 때문에 멈춘 건 경기뿐이라고 믿는다.",
        "하늘은 신중하고 나는 괜히 창밖만 자주 본다.",
        "준비는 다 했고 일정만 구름과 협의 중이다.",
      ],
      soft: [
        "야구 없는 밤도 다음 응원을 데워두는 시간.",
        "젖은 마음은 수건으로, 팬심은 천천히 말리기.",
        "오늘 쉬어가도 내 응원은 다음 날 선발이다.",
        "잠시 멈춘 시간도 다음 설렘을 위한 여백이다.",
        "비가 지나갈 때까지 마음도 느긋하게 쉬어간다.",
      ],
      chaos: [
        "구름 상대로 번트 작전을 고민하는 중.",
        "우천 대기 5분 만에 인생 작전회의 돌입.",
        "빗방울마다 사인을 보내는 기분.",
        "우산 각도까지 조정하며 혼자 분위기를 읽는 중.",
        "창밖 확인 횟수만으로 오늘의 집중력을 증명했다.",
      ],
    },
  },
  commute: {
    ...
    phrases: {
      hype: [
        ...
        "문이 열릴 때마다 오늘의 흐름도 한 칸 전진한다.",
        "도착만 하면 마음속 응원도 바로 시작할 수 있다.",
      ],
      deadpan: [
        "출근길 컨디션은 불안하지만 등판은 확정.",
        "아침 회의는 언제나 예고 없는 만루다.",
        "퇴근 전까지 실점만 줄여보자는 마음.",
        "환승은 성공했고 집중력은 다음 칸에 두고 왔다.",
        "앉을 자리는 없지만 오늘 할 일은 이미 줄을 섰다.",
      ],
      soft: [
        "오늘 하루도 한 타자씩만 상대하자.",
        "느린 출근길에도 마음은 천천히 몸을 푼다.",
        "완벽하지 않아도 등판한 것만으로 충분하다.",
        "조금 늦어도 내 속도대로 하루에 들어가면 된다.",
        "복잡한 길에서도 숨 한 번 고르면 마음은 따라온다.",
      ],
      chaos: [
        "알람을 놓쳤지만 작전은 방금 짰다.",
        "지하철 환승을 더블플레이처럼 처리하고 싶다.",
        "커피, 가방, 정신줄이 동시에 불펜 투입.",
        "문이 닫히기 전 몸과 가방이 서로 다른 판단을 했다.",
        "환승 안내보다 내 머릿속 회의가 더 빠르게 바뀐다.",
      ],
    },
  },
  extra: {
  ...
  dugout: {
    ...
    phrases: {
      hype: [
        ...
        "마음속 선택 하나에도 오늘은 이유를 크게 붙인다.",
        "설명할수록 자신감이 자라는 신기한 작전 시간.",
      ],
      deadpan: [
        "내가 짠 작전은 늘 결과를 보고 완벽해진다.",
        "차분한 분석인 척 사실은 감정 기용.",
        "입으로는 침착, 손은 계속 작전판.",
        "아는 건 적지만 고개를 끄덕이는 속도는 빠르다.",
        "결론은 늦게 내고 확신은 먼저 준비해뒀다.",
      ],
      soft: [
        "오늘의 선택도 하나씩 이유를 찾아가면 된다.",
        "큰 그림은 없어도 작은 응원은 정확히 보낸다.",
        "마음의 벤치에서 나에게 사인을 보낸다.",
        "정답을 몰라도 함께 바라보는 마음이면 충분하다.",
        "한 번의 선택보다 오래 응원하는 태도를 믿어본다.",
      ],
      chaos: [
        "갑자기 번트, 갑자기 강공, 갑자기 간식.",
        "작전 회의 3초 만에 직감 야구로 전환.",
        "내 머릿속 수비 시프트가 자꾸 생활까지 번진다.",
        "첫 생각과 두 번째 생각이 벌써 서로 다른 편이다.",
        "머릿속 화살표만 늘고 간식 위치는 더 선명해졌다.",
      ],
    },
  },
  solo: {
    ...
    phrases: {
      hype: [
        ...
        "한 사람의 박수도 오늘 분위기를 충분히 크게 만든다.",
        "조용한 방 안에서도 응원 에너지는 선명하게 돈다.",
      ],
      deadpan: [
        "혼자라서 차분한 줄 알았는데 표정이 먼저 들켰다.",
        "아무도 안 보는데 괜히 자세를 고쳐 앉았다.",
        "혼자 보는 날의 장점은 모든 해설이 내 편이라는 것.",
        "대화 상대는 없고 내 표정만 계속 답을 한다.",
        "조용히 보겠다는 계획은 첫 리액션에서 끝났다.",
      ],
      soft: [
        "조용히 보는 응원도 충분히 뜨겁다.",
        "오늘의 작은 박수는 내 방 안에서 오래 울린다.",
        "혼자 있어도 좋아하는 마음은 혼자가 아니다.",
        "내 속도대로 좋아하는 시간을 보내는 것도 응원이다.",
        "작은 미소 하나만으로도 오늘 마음은 충분히 전해진다.",
      ],
      chaos: [
        "혼자 관전, 혼자 해설, 혼자 작전 회의까지 완료.",
        "방금 소파가 응원석으로 전환됐다.",
        "말 없는 과몰입이 제일 시끄러운 법.",
        "혼잣말이 늘어나더니 어느새 진행까지 맡고 있다.",
        "손뼉 한 번에 방 안 분위기가 혼자 급변했다.",
      ],
    },
  },
  snack: {
    ...
    phrases: {
      hype: [
        ...
        "좋아하는 맛이 들어오자 마음의 박자도 살아났다.",
        "오늘의 박수는 바삭한 소리와 함께 더 커진다.",
      ],
      deadpan: [
        "간식은 줄었고 긴장은 늘었다.",
        "입은 바쁜데 마음은 계속 대기 타는 중.",
        "이 정도면 간식도 응원 스태프다.",
        "한 봉지만 먹겠다는 계획은 분위기와 함께 사라졌다.",
        "긴장은 그대로인데 접시만 이상하게 가벼워졌다.",
      ],
      soft: [
        "천천히 먹고 천천히 응원해도 괜찮다.",
        "좋아하는 맛 하나면 긴장도 조금은 둥글어진다.",
        "오늘은 간식과 마음을 같이 나눠 먹는 날.",
        "따뜻한 한입이면 바쁜 마음도 잠깐 쉬어갈 수 있다.",
        "천천히 나눠 먹는 시간까지 오늘의 좋은 장면이다.",
      ],
      chaos: [
        "간식 뜯는 순간 분위기 전환 의식 시작.",
        "작전은 없고 과자는 있다.",
        "손은 간식, 눈은 화면, 마음은 이미 전력질주.",
        "응원 타이밍과 한입 타이밍이 자꾸 정면 충돌한다.",
        "봉지 여는 소리에 혼자 새로운 흐름을 선언했다.",
      ],
    },
  },
  workday: {
    ...
    phrases: {
      hype: [
        ...
        "업무 모드 종료, 응원 모드 등판.",
        "하루를 버틴 힘이 이제 좋아하는 시간으로 넘어간다.",
        "문을 닫는 순간 마음속 응원 불빛이 바로 켜졌다.",
      ],
      deadpan: [
        "일은 끝났는데 긴장감은 새로 출근했다.",
        "퇴근했더니 마음이 연장전에 들어갔다.",
        "하루를 버틴 나에게 야구 기분을 지급한다.",
        "할 일은 끝났고 생각은 아직 자리 정리 중이다.",
        "몸은 집에 왔는데 긴장감만 조금 늦게 퇴근한다.",
      ],
      soft: [
        "오늘 하루도 여기까지 왔으니 천천히 응원하자.",
        "피곤한 마음을 야구 소리 옆에 내려놓는다.",
        "퇴근 후의 작은 설렘이면 오늘은 충분하다.",
        "수고한 마음을 편한 자리에 앉히고 천천히 본다.",
        "오늘의 피로도 좋아하는 시간 옆에서는 잠시 작아진다.",
      ],
      chaos: [
        "노트북은 닫았고 마음속 작전판은 열렸다.",
        "집에 오자마자 응원 회의 긴급 소집.",
        "피곤한데 리액션만큼은 풀타임 가능.",
        "가방을 내려놓자마자 마음속 회의가 새로 시작됐다.",
        "저녁 계획은 단순했는데 리액션만 갑자기 바빠졌다.",
      ],
    },
  },
};
